...
const POSITION_COORDS = {
  GK:  { x: 50, y: 88, label: 'POR' },
  RB:  { x: 80, y: 72, label: 'LD' },
  CB:  { x: 50, y: 72, label: 'DC' },
  LB:  { x: 20, y: 72, label: 'LI' },
  CDM: { x: 50, y: 57, label: 'MCD' },
  RM:  { x: 82, y: 45, label: 'MD' },
  CM:  { x: 50, y: 45, label: 'MC' },
  LM:  { x: 18, y: 45, label: 'MI' },
  CAM: { x: 50, y: 32, label: 'MCO' },
  RW:  { x: 80, y: 20, label: 'ED' },
  ST:  { x: 50, y: 16, label: 'DEL' },
  LW:  { x: 20, y: 20, label: 'EI' },
};
